            ...
            $("#saveRemarkBtn").click(function (){
                ...
                $.ajax({
                    ...
                    success : function (data){
                        ...
                        /*
                        data
                            {"success":true/false,"contactsRemark":{备注}}
                         */
                        if (data.success){
                            ...
                            html += '<font color="gray">联系人</font> <font color="gray">-</font> <b>${c.fullname}</b> <small style="color: gray;" id="s'+data.contactsRemark.id+'" > '+(data.contactsRemark.createTime)+' 由'+(data.contactsRemark.createBy)+'</small>';
                            html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                            html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\''+data.contactsRemark.id+'\')" ><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #2a5caa;"></span></a>';
                            html += '&nbsp;&nbsp;&nbsp;&nbsp;';
            ...
            $("#updateRemarkBtn").click(function (){
                ...
                $.ajax({
                    ...
                    success : function (data){
                        ...
                        /*
                            后台返回来的数据
                                {"success":true/false,"contactsRemark":{contactsRemark}}
                         */
                        if (data.success){
